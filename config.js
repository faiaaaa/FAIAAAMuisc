module.exports = {
	...
	token: process.env.token || "OTk3NjA4MzgwNDIyMTgwOTI1.GuQrOR.hD0q-DGTqr1RXMrFj0VLwuMHBVww3Ht6XoWxK4", //- Bot's Token
	clientId: process.env.clientId || "997608380422180925", //- ID of the bot
	clientSecret: process.env.clientSecret || "yvNeiUzKei-a8-1bDYj1fyWfLEYvNkkJ", //- Client Secret of the bot
	...
	nodes: [
		{
			...
			host: "lavalink-replit.jose-antonio264.repl.co", //- The host name or IP of the lavalink server.
	...
	presence: {
		...
		activities: [
			{
				name: "Palito con Nocha", //- Status Text
